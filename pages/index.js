  ...
  return (
    <Layout home>
      ...
      <section>
        ...
        <p className="my-4 leading-normal text-2xl">I am super bullish on crypto 🚀 especially <a href="https://www.coindesk.com/what-is-defi" target="_blank">Decentralized Finance (DeFi)</a> and my goal is to fully transition to blockchain development by the end of 2022.</p>
        <p className="my-4 leading-normal text-2xl">Currently available to work on crypto projects as a full-stack developer (including smart contract development in Solidity).</p>
